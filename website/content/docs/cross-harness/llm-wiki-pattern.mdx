...
If you're authoring workflows that you want to outlast a single tool's market position, this is the model to copy.
...
A reference packaging of any of these as a harness-kit plugin would be a strong contribution.
