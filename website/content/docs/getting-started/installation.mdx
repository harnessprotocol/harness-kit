...
Download the `.dmg` for your architecture from [GitHub Releases](https://github.com/harnessprotocol/harness-kit/releases/latest).
</Step>
<Step>
...
<Tab value="Binary">
Download the standalone binary (no Node.js required) from [GitHub Releases](https://github.com/harnessprotocol/harness-kit/releases/latest):
