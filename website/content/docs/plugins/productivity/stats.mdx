...
> **[View in Marketplace →](https://marketplace.harnessprotocol.io/plugins/stats)** for install tracking, related plugins, and profiles.
...
{/* @embed plugins/stats/skills/stats/SKILL.md */}

</Accordion>
<Accordion title="README.md — Plugin Documentation">

{/* @embed plugins/stats/skills/stats/README.md */}
