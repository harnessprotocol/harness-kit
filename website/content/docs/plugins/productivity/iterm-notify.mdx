...
> **[View in Marketplace →](https://marketplace.harnessprotocol.io/plugins/iterm-notify)** for install tracking, related plugins, and profiles.
...
{/* @embed plugins/iterm-notify/skills/iterm-notify/SKILL.md */}

</Accordion>
<Accordion title="README.md — Plugin Documentation">

{/* @embed plugins/iterm-notify/skills/iterm-notify/README.md */}
