...
export async function specNode(state) {
    ...
    const response = await model.invoke([
        new HumanMessage(`You are a senior engineer writing an implementation spec.\n\n` +
    ...
    const spec = typeof response.content === 'string'
        ? response.content
