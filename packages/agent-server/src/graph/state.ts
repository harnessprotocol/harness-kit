...
export const AgentState = Annotation.Root({
  ...
  subtasks: Annotation<Array<{ id: number; title: string; status: string; phase?: string }>>({
    default: () => [],
    reducer: (
      _a: Array<{ id: number; title: string; status: string; phase?: string }>,
      b: Array<{ id: number; title: string; status: string; phase?: string }>,
    ) => b,
  }),
  ...
  steeringMessage: Annotation<string | null>({
    default: () => null,
    reducer: (_a: string | null, b: string | null) => b,
  }),
  handoffRequested: Annotation<boolean>({
    default: () => false,
  ...
  task: Annotation<SerializableTask>({
    reducer: (_a: SerializableTask, b: SerializableTask) => b,
  } as never),
  ...
  allowedTools: Annotation<string[] | undefined>({
    default: () => undefined,
    reducer: (_a, b) => b,
  }),
});
