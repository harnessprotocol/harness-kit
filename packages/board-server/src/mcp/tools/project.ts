...
export const projectTools = [
  {
    ...
    handler: async (args: { name: string; description?: string; color?: string; repo_url?: string }) => {
      const project = store.createProject({ name: args.name, description: args.description, color: args.color, repo_url: args.repo_url });
