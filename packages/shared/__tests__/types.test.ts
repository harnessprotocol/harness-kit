...
describe("Profile YAML", () => {
  it("validates ProfileYaml interface with all fields", () => {
    const yaml: ProfileYaml = {
      ...
      knowledge: {
        backend: "vector-db",
        seed_docs: [{ topic: "API", description: "API docs" }],
      },
      rules: ["rule1", "rule2"],
    };
...
describe("Desktop app types", () => {
  ...
  it("validates HooksConfig type", () => {
    const config: HooksConfig = {
      "pre-commit": [{ type: "skill", command: "/lint" }],
      "post-build": [
...
describe("Marketplace manifest", () => {
  ...
  it("validates MarketplaceManifest interface", () => {
    const manifest: MarketplaceManifest = {
      ...
      categories: [{ slug: "productivity", name: "Productivity", display_order: 1 }],
      plugins: [
        {
          name: "test",
          source: "./plugins/test",
...
describe("Comparator types", () => {
  ...
  it("validates ComparisonRequest interface", () => {
    const request: ComparisonRequest = {
      ...
      workingDir: "/path/to/dir",
      pinnedCommit: "abc123",
      panels: [{ panelId: "panel-1", harnessId: "harness-1" }],
    };
...
describe("Persistence types", () => {
  ...
  it("validates ReplaySetup interface", () => {
    const setup: ReplaySetup = {
      ...
      workingDir: "/path",
      pinnedCommit: "abc123",
      panels: [{ harnessId: "harness-1", harnessName: "Test", model: "claude-3-5-sonnet" }],
    };
