...
stamp_json "$REPO_ROOT/packages/exchange/package.json"
stamp_json "$REPO_ROOT/packages/ui/package.json"
stamp_json "$REPO_ROOT/packages/marketplace-data/package.json"
stamp_json "$REPO_ROOT/packages/design-tokens/package.json"
stamp_json "$REPO_ROOT/packages/website-data/package.json"
stamp_json "$REPO_ROOT/apps/cli/package.json"
stamp_json "$REPO_ROOT/apps/desktop/package.json"
