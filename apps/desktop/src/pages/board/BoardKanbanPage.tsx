...
import { type ViewMode, ViewToggle } from "../../components/board/ViewToggle";
import { ExecutionProvider } from "../../contexts/ExecutionContext";
import { useBoardData } from "../../hooks/useBoardData";
import { useBoardServerReady } from "../../hooks/useBoardServerReady";
import type { Epic, Project, Task, TaskStatus } from "../../lib/board-api";
...
export default function BoardKanbanPage() {
  ...
  const openTaskForm = useCallback(
    (status: TaskStatus, epicId?: number) => {
