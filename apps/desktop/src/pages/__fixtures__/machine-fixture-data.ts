  ...
  rows: [
    {
      ...
      cells: {
        ...
        // Plugin models HarnessKit reads no store for: unmanaged, not absent.
        "copilot-vscode": { status: "unmanaged", entries: [] },
        "copilot-cli": { status: "unmanaged", entries: [] },
        codex: {
          status: "present",
          effectiveDigest: "sha256:b0a4d17e55",
          entries: [
        ...
        opencode: { status: "unmanaged", entries: [] },
        windsurf: { status: "unmanaged", entries: [] },
        gemini: { status: "unmanaged", entries: [] },
        junie: { status: "unmanaged", entries: [] },
      },
    },
    {
