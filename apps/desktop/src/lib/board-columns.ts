...
export const COLUMN_META: Record<TaskStatus, { label: string; color: string; tooltip: string }> = {
  backlog: {
    ...
    tooltip: "Captured ideas and future work — drag to Planning when ready to scope",
  },
  planning: {
    label: "Planning",
    color: "var(--status-planning)",
    tooltip: "Not started — tasks being scoped and planned",
  },
  "in-progress": {
    label: "In Progress",
    color: "var(--status-in-progress)",
    tooltip: "Actively being worked on — a worktree is created automatically",
  },
  "ai-review": {
    label: "AI Review",
    color: "var(--status-ai-review)",
    tooltip: "Under automated review — Claude is verifying the implementation",
  },
  "human-review": {
    label: "Human Review",
    color: "var(--status-human-review)",
    tooltip: "Ready for human review — AI review is complete",
  },
...
export const EMPTY_STATE_COPY: Record<TaskStatus, { title: string; subtitle: string }> = {
  ...
  "in-progress": {
    ...
    subtitle: "Start a task from Planning — a worktree is created automatically",
  },
  "ai-review": {
    title: "No tasks in AI review",
    subtitle: "Claude will verify implementations here",
  },
  "human-review": {
    title: "Nothing to review",
    subtitle: "Tasks pass AI review before landing here",
  },
