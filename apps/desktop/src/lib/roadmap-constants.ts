import type { RoadmapFeaturePriority, RoadmapFeatureStatus } from "./roadmap-types";
...
export const ROADMAP_PRIORITY_CONFIG: Record<
...
export const ROADMAP_COMPLEXITY_CONFIG: Record<
  "low" | "medium" | "high",
...
export const ROADMAP_IMPACT_CONFIG: Record<
  "low" | "medium" | "high",
  { label: string; color: string }
> = {
