...
import type { Competitor, CompetitorAnalysis, Roadmap, RoadmapFeature } from "./roadmap-types";
...
export const roadmapApi = {
  roadmap: {
    get: (slug: string) => apiFetchOrNull<Roadmap>(`/projects/${slug}/roadmap`),
  ...
  competitors: {
    get: (slug: string) => apiFetchOrNull<CompetitorAnalysis>(`/projects/${slug}/competitors`),
