    ...
    <div ref={menuRef} style={{ position: "relative" }}>
      ...
      >
        ...
        <svg width="8" height="8" viewBox="0 0 8 8" style={{ color: "var(--fg-subtle)" }}>
          <path d="M1 2.5l3 3 3-3" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
        </svg>
      </button>
      ...
      {open && (
        <div style={{
          ...
          minWidth: "160px", zIndex: 10, padding: "3px", overflow: "hidden",
        }}>
          <button
            onClick={() => { onExportZip(); setOpen(false); }}
            style={{
              display: "block", width: "100%", textAlign: "left",
              padding: "6px 10px", fontSize: "12px", border: "none",
          ...
          <button
            onClick={() => { onExportFolder(); setOpen(false); }}
            style={{
              display: "block", width: "100%", textAlign: "left",
              padding: "6px 10px", fontSize: "12px", border: "none",
              borderRadius: "5px", background: "transparent",
