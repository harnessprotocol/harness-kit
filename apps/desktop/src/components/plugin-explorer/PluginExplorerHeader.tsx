      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        ...
        <AnimatePresence mode="wait">
          {confirmState !== "idle" ? (
            ...
            >
              <button className="btn btn-sm btn-accent" onClick={onRequestSave} disabled={saving}>
                {saving ? "Saving..." : "Save"}
              </button>
              <button className="btn btn-sm btn-secondary" onClick={onRevert} disabled={saving}>
                Revert
              </button>
            </motion.div>
          ) : savedRecently ? (
